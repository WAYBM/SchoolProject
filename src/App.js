...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div style={{ marginRight: (window.innerWidth / 100) * 10, marginLeft: (window.innerWidth / 100) * 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div className='nahuietovse'>
          ...
          <div style={{ position: 'absolute', width: '60px', height: '60px', marginLeft: 575, marginTop: '335px', cursor: 'pointer' }} onClick={(e) => {
            setdispl('block')
        ...
        <div className='KPD' style={{ display: 'flex', flexDirection: 'row' }}>
          <div>
            <div style={{ backgroundImage: `url(${water})`, marginTop: '100px', alignSelf: 'center', width: '500px', height: '75px', borderRadius: '10px' }}>
              <p style={{ color: 'white', fontSize: 'xx-large', fontWeight: '500', padding: '' }}>КПД парового двигателя</p>
            </div>
            <img src={kpd1}></img>
            <img src={kpd2}></img>
          </div>
          <div style={{ backgroundImage: `url(${water})`, marginTop: '100px', alignSelf: 'center', width: '500px', height: '75px', borderRadius: '10px' }}>
            <p style={{ color: 'white', fontSize: 'xx-large', fontWeight: '500', padding: '' }}>Калькулятор КПД</p>
          </div>
        </div>
        <div className="main3">
          <table>
            <tr><th>План дальнейшего развития сайта</th></tr>
            <tr><td>• Добавление игры</td></tr>
            <tr><td>• Добавление больше информации</td></tr>
            <tr><td></td></tr>
            <tr><td></td></tr>
          </table>
        </div>
      ...
      <div className='opinion'>
        <p style={{ alignSelf: 'center', color: 'white' }}>Отзыв о нашем сайте</p>
        <div style={{ display: 'flex', flexDirection: 'row', alignSelf: 'center' }}>
          <textarea cols='40' rows='3' style={{ width: 'auto', fontSize: 'large', fontFamily: "Montserrat Alternates", borderRadius: '10px' }}></textarea>
          <button style={{ width: '200px', height: '50px', alignSelf: 'center', marginLeft: '50px' }}>Отправить</button>
        </div>
      </div>
    </div>
  );
